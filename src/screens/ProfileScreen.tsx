      ...
      <div className="flex flex-col items-center p-8 bg-white border-2 border-emerald-100 rounded-[32px] shadow-sm">
        ...
        {profile.classId && (
          <div className="flex items-center gap-2 mt-2">
            <span className="px-2 py-0.5 bg-slate-100 text-slate-500 rounded-lg text-[10px] font-black uppercase tracking-tighter">
              Класс {profile.classId}
            </span>
            {profile.subject && (
              <span className="px-2 py-0.5 bg-indigo-100 text-indigo-600 rounded-lg text-[10px] font-black uppercase tracking-tighter">
                {profile.subject}
              </span>
            )}
          </div>
