      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5 pb-32">
        {activeTab === 'dashboard' && (
          <div className="space-y-5 animate-in slide-in-from-bottom-5 duration-300">
             ...
             <div className="bg-emerald-600 p-6 rounded-[32px] text-white shadow-xl shadow-emerald-500/10 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>
                <div className="flex justify-between items-start mb-4">
                   <div className="bg-white/10 p-2.5 rounded-xl border border-white/10"><Sparkles size={20} strokeWidth={2.5} className="text-white" /></div>
                   <span className="text-[9px] font-black uppercase tracking-widest py-1 px-2.5 bg-white/10 rounded-lg border border-white/5">Совет ИИ</span>
                </div>
                <h3 className="text-lg font-bold leading-tight mb-2 tracking-tight">Класс 9-A отстает по Геометрии</h3>
