...
export default function BottomNav({ activeTab, onChange, role = 'student' }: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100/50 px-6 py-3 pb-8 sm:pb-3 flex justify-between z-50 shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.05)]">
      {currentTabs.map(tab => {
